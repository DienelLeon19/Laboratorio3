...
public class ListaPersonas extends javax.swing.JFrame {
    ...
    public ListaPersonas(Registro padre, Persona selec){
        
        initComponents();
        this.padre = padre;
        this.selec= selec;
        
        date1.setText(selec.getNombre());
        date2.setText(selec.getApellido());
        date3.setText(selec.getDni());
    ...
    private void initComponents() {
        ...
        date1.setText("El nombre ingresado");

        date2.setText("El apellido ingresado");

        date3.setText("El DNI ingresado");
